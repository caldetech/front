...
export default function NewHeader({
  ...
  return (
    <div className="absolute sm:static top-0 sm:z-10 sm:flex sm:flex-col flex w-full">
      <header className="sm:justify-end sm:w-full sm:flex sm:h-14 sm:items-center sm:gap-2 sm:border-b sm:border-foreground/10 sm:bg-background sm:px-4 lg:h-[60px] sm:justify-between">
